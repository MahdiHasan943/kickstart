            ...
            {scraperShowSuccess && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Scraping Started!</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-6 font-medium">Your task has been added to the queue. You'll see results in the table below shortly.</p>
                        <button
                            onClick={() => setScraperShowSuccess(false)}
                            className="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-200 dark:shadow-none"
                        >
                            Got it
                        </button>
                    </div>
